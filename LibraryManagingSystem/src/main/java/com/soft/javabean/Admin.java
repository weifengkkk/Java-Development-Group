...
public class Admin {
	...
	public AdminEntity findAdminByNameAndPwd(String username, String pwd)
	{
		return adminMapper.findAdminByNameAndPwd(username,pwd);
	}
...
//		System.out.println(Util.passMd5(password));
...
//		}
		...
		AdminEntity adminEntity = findAdminByNameAndPwd(username, Util.passMd5(password));

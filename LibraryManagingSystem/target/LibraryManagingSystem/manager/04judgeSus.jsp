<%@ page import="com.soft.javabean.DateTime" %>
<%@ page import="com.soft.javabean.CompareDate" %>
...
<body>
<jsp:useBean id="judge" scope="session" class="com.soft.javabean.JDBCBean"></jsp:useBean>
<%

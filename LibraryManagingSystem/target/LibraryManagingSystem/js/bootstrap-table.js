(function (global, factory) {
	...
	*/
	...
	// `Array.prototype.{ forEach, map, com.soft.filter, some, every, find, findIndex }` methods implementation
	    ...
	    for (;length > index; index++) if (NO_HOLES || index in self) {
	      ...
	      if (TYPE) {
	        if (IS_MAP) target[index] = result; // map
	          ...
	          case 2: push.call(target, value); // com.soft.filter
	...
	var arrayIteration = {
	  ...
	  // `Array.prototype.com.soft.filter` method
	  ...
	  _createClass(BootstrapTable, [{
	    ...
	    value: function initSearch() {
	      ...
	      if (this.options.sidePagination !== 'server') {
	        ...
	        var f = Utils.isEmptyObject(this.filterColumns) ? null : this.filterColumns; // Check com.soft.filter

...
<%@page import="com.soft.javabean.JDBCBean"%>
...
<body>
	...
	<script>
		...
		layui.use(['table', 'jquery'],function(){
		  ...
		  // 直接编辑
		  table.on('edit(form)', function(obj){ //注：edit是固定事件名，test是table原始容器的属性 lay-com.soft.filter="对应的值"
		...
		// 监听侧边工具条  编辑，删除
		 table.on('tool(form)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-com.soft.filter="对应的值"
